...
insert into coupon (business_id, qrcode, title, image, item_name, description, original_price, coupon_price, coupon_savings, start_at, end_at)
values (2, 'qrcode2', '$20 off sneakers', 'https://facebook.github.io/react/img/logo_og.png', 'Shoes', 'Cool Sneakers', 120.00, 100.00, 20.00, '2017-01-05 01:00:00', '2017-01-29 03:00:00');
