...
values (1, '$20 Off Polo', '$20 Off Polo', 'https://storage.googleapis.com/qupid-image/vineyardvines.jpg', 'Men’s Colorful Polo', "Now crafted with an updated fit, you'll never forget the colors of the rainbow!", 95.00, 75.00, 20.00, '2017-01-18 16:00:00', '2017-01-27 21:25:00');
-- // picture checked
insert into coupon (business_id, qrcode, title, image, item_name, description, original_price, coupon_price, coupon_savings, start_at, end_at)
values (1, '$10 Off Shorts', '$10 Off Shorts', 'https://storage.googleapis.com/qupid-image/vineyardvinesshorts.jpg', 'Men’s Redux Seersucker Shorts', 'These casual shorts are perfect for the summer, the boat and for you.', 80.00, 70.00, 10.00, '2017-01-15 16:00:00', '2017-01-27 21:25:00');
-- // picture checked
insert into coupon (business_id, qrcode, title, image, item_name, description, original_price, coupon_price, coupon_savings, start_at, end_at)
values (2, 'Buy 1 Get 1 Free!', 'Buy 1 Get 1 Free!', 'https://storage.googleapis.com/qupid-image/beardpapas.jpg', 'Delicious Cream Puffs', 'Delicious and warms the soul. Get your Beard Papas today!', 5.00, 2.50, 2.50, '2017-01-17 16:00:00', '2017-01-27 21:25:00');
-- // picture checked
insert into coupon (business_id, qrcode, title, image, item_name, description, original_price, coupon_price, coupon_savings, start_at, end_at)
values (3, '30% Off Tuition', '30% Off Tuition', 'https://storage.googleapis.com/qupid-image/hackreactorstock1.jpeg', 'JavaScript Skills', 'Reinvent your career in 12 weeks and level up your web dev skills!', 18000, 12600, 5400, '2017-01-15 03:00:00', '2017-02-10 09:00:00');

-- // coupon: Expired
-- // picture checked
insert into coupon (business_id, qrcode, title, image, item_name, description, original_price, coupon_price, coupon_savings, start_at, end_at)
values (2, '50% Off Cream Puff', '50% Off Cream Puff', 'https://storage.googleapis.com/qupid-image/beardpapas2.jpg', 'Delicious Cream Puffs', 'Delicious and warms the soul. Get your Beard Papas today!', 5.00, 2.50, 2.50, '2017-01-10 16:00:00', '2017-01-11 16:00:00');

-- // coupon: Used
-- // picture checked
insert into coupon (business_id, qrcode, title, image, item_name, description, original_price, coupon_price, coupon_savings, start_at, end_at)
values (3, 'Free Precourse', 'Free Precourse', 'https://storage.googleapis.com/qupid-image/hackreactorstock2.jpeg', 'Free Prep Materials', 'Scared you can’t do recursion? Well get your tail out from between your legs and let’s n-queen it up!', 2500, 0, 2500, '2017-01-15 16:00:00', '2017-01-27 16:00:00');
