...
values (1, '$5 off socks', 'socks.png', 'Socks', 'Colorful Socks', 10.00, 5.00, 5.00, '2017-01-05 16:00:00', '2017-01-05 18:00:00');

insert into coupon (business_id, title, image, item_name, description, original_price, coupon_price, coupon_savings, start_at, end_at)
values (2, '$20 off jacket', 'jacket.png', 'Jackets', 'North Face', 120.00, 100.00, 20.00, '2017-01-05 01:00:00', '2017-01-05 03:00:00');

insert into coupon (business_id, title, image, item_name, description, original_price, coupon_price, coupon_savings, start_at, end_at)
values (3, '$4 off shampoo', 'shampoo.png', 'Shampoo', 'Suave Biotin Infusion', 8.00, 4.00, 4.00, '2017-01-06 03:00:00', '2017-01-06 09:00:00');
